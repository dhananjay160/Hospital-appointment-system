...
// const Header = () => {
//   return (
//     <div className='flex flex-col md:flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20' >
//         {/* -----Left Side------- */}
  ...
  return (
    <div className="flex flex-col md:flex-row bg-primary rounded-lg px-6 md:px-10 lg:px-20">
      ...
      <div className="md:w-1/2 flex justify-center md:justify-end relative">
        <img
          className="w-full md:w-auto md:absolute bottom-0 right-0 h-auto rounded-lg"
